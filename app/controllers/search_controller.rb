class SearchController < ApplicationController
  ...
  SERVER = "phenoscape-dev.nescent.org"
  ...
  def anatomy
    @term = params[:id]
    response = Net::HTTP.get_response(SERVER, "/OBD-WS/phenotypes/summary/anatomy/" + @term)
  ...
  def gene
    @term = params[:id]
    response = Net::HTTP.get_response(SERVER, "/javascripts/dummy_gene_summary.js")
  ...
  def phenotypes
    ...
    if type == "taxa"
      ...
      response = Net::HTTP.get_response(SERVER, "/javascripts/dummy_anatomy_results_taxon.js")
      @results = ActiveSupport::JSON.decode(response.body)
      ...
      response = Net::HTTP.get_response(SERVER, "/javascripts/dummy_anatomy_results_gene.js")
      @results = ActiveSupport::JSON.decode(response.body)
